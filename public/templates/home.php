  <div id="deathToll" class="alert alert-danger">
    <h2>{{ deathToll }}</h2>
  </div>
  ...
  <div class="page-header" style="margin-top: 0;">
    <h1 style="margin-top: 0;">Nicotine's Kryptonite
      <!--<span ng-show="version" style="color: red;">&nbsp;{{ version }}</span>-->
      <br /><small>Helping you help yourself</small></h1>
  </div>
